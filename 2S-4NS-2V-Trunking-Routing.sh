...
echo "\n"
echo "Configure switched virtual interface VLAN20 in switch s2"
ovs-vsctl add-port s2 vlan20 tag=20 -- set interface vlan20 type=internal
echo "\n"
echo "Assign IP address 192.168.2.10/24 to switched virtual interface VLAN20 in switch s2"
...
echo "\n"
echo "Bring switched virtual interface VLAN20 in switch s2 down"
ip link set vlan20 down
echo "\n"
echo "Delete switched virtual interface VLAN20 in switch s2"
ovs-vsctl del-port s2 vlan20
echo "\n"
