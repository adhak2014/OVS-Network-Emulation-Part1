...
echo "\n"
echo "Assign IP address 192.168.1.3/24 to virtual interface h3-eth0"
...
echo "\n"
echo "Assign IP address 192.168.1.4/24 to virtual interface h4-eth0"
...
echo "In h3 namespace, ping 192.168.1.4"
ip netns exec h3 ping -c1 192.168.1.4
echo "\n"
echo "Check IPv4 reachability between h1 namespace and h3 namespace"
echo "In h1 namespace, ping 192.168.1.3"
ip netns exec h1 ping -c1 -w1 192.168.1.3
echo "\n"
echo "Check IPv4 reachability between h4 namespace and h2 namespace"
echo "In h3 namespace, ping 192.168.1.2"
ip netns exec h4 ping -c1 -w1 192.168.1.2
echo "\n"
